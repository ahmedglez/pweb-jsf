...
public class DriverService implements CrudInterface {
  ...
  public List<DriverDto> getAll() {
    ...
    try {
      ...
      String response = (String) restService
        .GET("/drivers/all", params, String.class, UserBean.token)
        .getBody();
  ...
  public void create(Object dto) {
    ...
    String response = (String) restService
      .POST("/drivers/", driver, String.class, UserBean.token)
      .getBody();
  ...
  public void update(Object dto) {
    ...
    MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
    String response = (String) restService
      .PUT("/drivers/", params, driver, String.class, UserBean.token)
      .getBody();
    System.out.println(response);
  }
