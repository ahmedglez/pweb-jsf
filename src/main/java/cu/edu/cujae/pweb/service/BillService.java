...
public class BillService implements CrudInterface {
    ...
    public List<BillDto> getAll() {
        ...
        try {
            ...
            String response = (String)restService.GET("/api/v1/contracts/bills/all", params, String.class,  UserBean.token).getBody();
    ...
    public BillDto getByCode(int code) {
        ...
        try {
            ...
            UriTemplate template = new UriTemplate("/api/v1/contracts/bills/{code}");
    ...
    public void create(Object dto) {
        ...
        String response = (String) restService.POST("/api/v1/contracts/bills/", bill, String.class,  UserBean.token).getBody();
    ...
    public void update(Object dto) {
        BillDto bill = (BillDto) dto;
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        String response = (String) restService.PUT("/api/v1/contracts/bills/", params, bill, String.class,  UserBean.token).getBody();
        System.out.println(response);
    }
