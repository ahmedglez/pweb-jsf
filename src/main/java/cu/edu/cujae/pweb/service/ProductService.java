...
public class ProductService {
    ...
    public void init() {
        ...
        products.add(new Product(1000, "f230fh0g3", "Bamboo Watch", "Product Description", 65,
                "Accessories", 24, 5));
        products.add(new Product(1001, "nvklal433", "Black Watch", "Product Description", 72,
                "Accessories", 61, 4));
        products.add(new Product(1002, "zz21cz3c1", "Blue Band", "Product Description", 79,
                "Fitness", 2, 3));
        products.add(new Product(1003, "244wgerg2", "Blue T-Shirt", "Product Description", 29,
                "Clothing", 25, 5));
        products.add(new Product(1004, "h456wer53", "Bracelet", "Product Description", 15,
                "Accessories", 73, 4));
        products.add(new Product(1005, "av2231fwg", "Brown Purse", "Product Description", 120,
                "Accessories", 0, 4));
        products.add(new Product(1006, "bib36pfvm", "Chakra Bracelet", "Product Description", 32,
                "Accessories", 5, 3));
        products.add(new Product(1007, "mbvjkgip5", "Galaxy Earrings", "Product Description", 34,
                "Accessories", 23, 5));
        products.add(new Product(1008, "vbb124btr", "Game Controller", "Product Description", 99,
                "Electronics", 2, 4));
        products.add(new Product(1009, "cm230f032", "Gaming Set", "Product Description", 299,
                "Electronics", 63, 3));
        products.add(new Product(1010, "plb34234v", "Gold Phone Case", "Product Description", 24,
                "Accessories", 0, 4));
